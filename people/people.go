...
// SetAllExtrasForGetPhotos populates the Extras field with all possible
// values, ensuring that all possible data comes back in the response.
func SetAllExtrasForGetPhotos(a *GetPhotosOptionalArgs) {
